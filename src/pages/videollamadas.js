...
const Videollamadas = () => (
  <>
    <SEO title="Videollamadas" description="Inicia una videollamada gratuita" />
    <div className="inner-container grid">
      ...
      <div className="inner-text desktop-text">
        ...
        <p>
          ...
          segura e ilimitada. Te recomendamos que la uses en Google Chrome para
          obtener los mejores resultados. Puedes invitar a todos los que
          quieras. No necesitas instalar nada si lo usas en tu computador
          personal.
        </p>
        <p className="attention">
          <AttentionIcon />
          <strong>Atención</strong> este servicio gratuito se brinda sin ninguna
    ...
    <div className="inner-container grid">
      <div className="inner-text">
        ...
        <p>
          ...
          aplicación Jitsi Meet, un software de videoconferencias gratuito y de
          código abierto. Descarga la aplicación para tu teléfono.
        </p>
